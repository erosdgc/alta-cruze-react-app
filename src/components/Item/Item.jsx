        ...
        <div className="container">
            <article className="card rounded-0 border-0 shadow p-xxl-3 mt-5" key={item.id}>
                <div className="row justify-content-md-center">
                    <div className="img-hover-zoom img-hover-zoom--quick-zoom card border-0 rounded-0 card-image col-xxl-6 col-xl-8 col-lg-8 col-md-12 col-sm-12 col-xs-12 me-auto p-sm-0 p-xs-0 px-xl-0 px-xxl-3">
                        <Link to={`/detail/${item.id}`}><img className="img-fluid izo" src={item.image} alt={item.alt} /></Link>
                    </div>
                    <div className="mx-auto shadow-sm card border-0 rounded-0 card-item p-3 col-xxl-3 col-xl-4 col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        <Link className="text-decoration-none" to={`/detail/${item.id}`}><h2 className="card-name roboto-font display-6 text-dark">{item.title}</h2></Link>
